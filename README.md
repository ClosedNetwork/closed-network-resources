...
|---|---|---|
| [Flock Briefing Packet](./flock-briefing-packet/) | v1.0 — April 2026 | Resident's toolkit for pushing back on Flock Safety license-plate surveillance. Includes a sourced timeline, FOIA template, council script, and rebuttals to the predictable pushback. |
...
1. **Submit your city's win or loss.** Did your town vote on a Flock contract? Open an Issue using the *"Add a city vote"* template. We'll add it to the timeline.
2. **Report a broken source or outdated claim.** Open an Issue using the *"Broken or outdated source"* template. We'll fix it.
3. **Translate a packet.** Open an Issue using the *"Translation request"* template. We can help coordinate.
